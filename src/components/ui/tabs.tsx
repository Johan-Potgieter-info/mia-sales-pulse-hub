...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-start rounded-lg bg-muted p-1 text-muted-foreground overflow-x-auto overflow-y-hidden scrollbar-hide gap-1",
      className
    )}
    {...props}
  />
